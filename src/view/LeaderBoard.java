  ...
  public LeaderBoard()
    ...
    getHighScore();
		//initializes the arrays with each person's high score
			//by default, the leaderboard will only show top 10 high scores
		if(scores.length < topScores)	//if there are less than 10, then numScores is set to that number to avoid array out of bounds exception below
